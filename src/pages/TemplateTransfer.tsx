...
function TemplateTransfer() {
    ...
    const [devices] = useState<Device[]>([
        { id: 1, TerminalId: "7565365635565", deviceName: "Hid amico 70", ipAddress: "192.168.1.10" },
        { id: 2, TerminalId: "7565365635567", deviceName: "Hid amico 35", ipAddress: "192.168.1.11" },
        { id: 3, TerminalId: "7565365635534", deviceName: "Hid amico 70", ipAddress: "192.168.1.11" },
        { id: 4, TerminalId: "7565365635765", deviceName: "Hid amico 70", ipAddress: "192.168.1.11" },
        { id: 5, TerminalId: "7565365635578", deviceName: "Hid amico 70", ipAddress: "192.168.1.11" }
                    ...
                    <div className='row'>
                                    ...
                                    <div className='col-12'>
                                        ...
                                        <div className='col-sm-12 col-md-12 col-lg-12 rowCheckPlease'>
                                            <div className="col-6 col-sm-6 col-md-6 col-lg-6 showAllRadioTextAlign">
                                                ...
                                                />
                                                <label id="rdo_DeviceShowAll" htmlFor="rdo_DeviceShowAll" className='mb-0'>
                                                    Show All Devices
                                                </label>
                                            </div>
                                            <div className="col-6 col-sm-6 col-md-6 col-lg-6 showAllRadioTextAlign">
                                                <div className='savebuttonDiv templateTransfer'>
                                                    <button className='btn-outline-soft-green templateTransfer'>Search</button>
                                                    <button className='btn-outline-soft-red templateTransfer'>Clear</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="col-12">
                            <div className='btntemplateTransfer templateTransfer'>
                                <button className='btn-outline-soft-green templateTransfer'>Template Transfer</button>
                                <button className='btn-outline-soft-red templateTransfer'>Cancel</button>
                            </div>
                        </div>
