    ...
    <>
      ...
      {openHID35 && modalRoot &&
        ReactDOM.createPortal(
          <div className="modal-overlay device-list" onClick={() => setOpen(false)}>
            <div
              className="custom-modal device-list"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="modal-header device-list">
                HID Amico VL35LF
              </div>
              ...
              <div className="modal-body device-list  ">
                ...
                <div className='row'>
                  <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12 row'>
                    ...
                    <div className='col-lg-6 col-md-6 col-sm-12'>
                      <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12 row'>
                        <div id='DetailsImagelink' className='col-lg-5 col-md-5 col-sm-1 col-xs-12  '>
                          <img
                            src={Filepng}
                            alt="HID Amico VL35LF"
                        ...
                        <div id='DetailsImagelink' className='col-lg-7 col-md-7 col-sm-2 col-xs-12  row-image-link   '>
                          <a href={Usermanual} target="_blank" className='download-link device-list'> User Manual</a>
                        </div>
                        ...
                        <div id='DetailsImagelink' className='col-lg-7 col-md-7 col-sm-2 col-xs-12  row-image-link    '>
                          <a href={broucher} target="_blank" className='download-link device-list'>Brochure</a>
                        </div>
                        ...
                        <div id='DetailsImagelink' className='col-lg-7 col-md-7 col-sm-2 col-xs-12  row-image-link   '>
                          ...
                          <a href={InstallationGuide} target="_blank" className='download-link device-list'> Installation Guide</a>
                        </div>
                        ...
                        <div id='DetailsImagelink' className='col-lg-7 col-md-7 col-sm-2 col-xs-12   row-image-link '>
                          <a className='download-link  device-list'> Wiring Diagram</a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12 '>
                      <button className="close-btn device-list" onClick={() => setOpen(false)}>
                        Close
                      </button>
                    </div>
                  </div>
      ...
      {openHID70 && modalRoot &&
        ReactDOM.createPortal(
          <div className="modal-overlay  device-list" onClick={() => setOpen1(false)}>
            <div
              className="custom-modal  device-list"
              onClick={(e) => e.stopPropagation()}
            >
              ...
              <div className="modal-body  device-list">
                ...
                <div className='col-lg-12 row'>
                  ...
                  <div className='col-lg-6 col-md-6 col-sm-12'>
                    <div id='BrouchersandSetting' className='col-lg-12 MarginTop row '>
                  ...
                  <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12  '>
                    <button className="close-btn  device-list" onClick={() => setOpen1(false)}>
                      Close
                    </button>
                  </div>
                </div>
              ...
              <div className="modal-footer  device-list">
